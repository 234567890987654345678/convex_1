...
поступающих точек плоскости и вычисляющую её периметр, площадь и максимальный угол, под которым видно из начала координат одно из самых длинных рёбер выпуклой оболочки. Возвращаемое значение: величина угла в градусах. Решение
...
Для нахождения максимального угла, под которым видно из начала координат одно из самых длинных рёбер выпуклой оболочки был создан метод `angle_vector`, который вычисляет угол между векторами с началами в точке (0;0) и концами в вершинах выпуклой оболочки. При добавлении новой вершины находится ребро максимальной длины и выводится соответствующий угол. Для случая нульугольника и одноугольника результат будет всегда нулевым. Для двуугольника результатом будет единственный угол, а для многоугольника сначала просто сравниваются длины рёбер и находится подходящий угол, а затем при добавлении новых вершин результат перевычисляется. Если при добавлении новой вершины удаляется текущее максимальное ребро, то происхожит перевычисление нового максимального, в обратном случае — новые рёбра сравниваются с текущим максимальным. Когда добавляется ребро, равное по длине максимальному, сравниваются углы, необходимые по условию, и выводится наибольший.
